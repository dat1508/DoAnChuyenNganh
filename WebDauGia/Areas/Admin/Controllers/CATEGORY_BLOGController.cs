...
namespace WebDauGia.Areas.Admin.Controllers
{
    public class CATEGORY_BLOGController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "IdCate,Name")] CATEGORY_BLOG cATEGORY_BLOG)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdCate,Name")] CATEGORY_BLOG cATEGORY_BLOG)
        {
            if (ModelState.IsValid)
            {
        ...
        // POST: Admin/CATEGORY_BLOG/Delete/5
